terraform {
  ...
  #   region         = "us-east-1"
  #   encrypt        = true
  #   dynamodb_table = "poker-pardner-terraform-locks"
  # }
}
...
resource "aws_cloudfront_origin_access_control" "website" {
  name                              = "poker-pardner-oac"
  description                       = "OAC for Poker Pardner S3 bucket"
...
resource "aws_cloudfront_distribution" "website" {
  ...
  ordered_cache_behavior {
    ...
    viewer_protocol_policy = "redirect-to-https"
    min_ttl                = 0
    default_ttl            = 31536000 # 1 year for hashed assets
    max_ttl                = 31536000
    compress               = true
  }
...
resource "aws_acm_certificate" "website" {
  ...
  tags = {
    Name        = "Poker Pardner Certificate"
    Environment = var.environment
    Project     = "poker-pardner"
  }
}
...
# Additional AWS provider for ACM certificate (must be in us-east-1)
provider "aws" {
  alias  = "us_east_1"
  region = "us-east-1"
}
